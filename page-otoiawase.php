...
<main>
  <section class="contact-section">
    <div class="container">
      <div class="contact">
        <h2>お問合せ</h2>
        <!-- <p>アプリの使用に関するお問合せは、<a href="https://libecity.com/user_profile/AdWOYYHZ5EgGA7rypXJoSZrN5Nf1">リベシティのDM</a>からご連絡ください。</p> -->
        <!-- <p>※デモアプリの使用にはGmailアドレスが必要です</p> -->
        
        <p>アプリの使用に関するお問合せは、下記のフォームでお願いします。</p>
        <p><a href="https://libecity.com/user_profile/AdWOYYHZ5EgGA7rypXJoSZrN5Nf1">リベシティの方はリベシティのDM</a>にてご連絡ください。</p>
        <p>※デモアプリの使用にはGmailアドレスが必要です</p>
